...
ALGORITHM_NAMES = ['OSM', 'BIM', 'CSI', 'SOM', 'CA']
...
def create_zeta_plot(benchmark):
    ...
    axis = benchmark.plot("zeta_p", axis=axis[0], show=False, yscale='log', method=["osm","bim", "csi", "som", "ca"])
...
def create_confidence_interval_plot(benchmark):
    ...
    fig, _ = benchmark.confint("zeta_p", show=False, paired=True, 
                               method=["osm","bim", "som", "ca"],
                               print_info=False)
...
if __name__ == "__main__":
    ...
    try:
        ...
        try:
            ...
            plots_created.append("./figs/plot.eps (zeta_p convergence)")
