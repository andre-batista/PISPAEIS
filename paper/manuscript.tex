...
\section{Computational Experiments}\label{sec:results}
    ...
    \subsection{Shape Recovering Study}\label{sec:results:shape}
        ...
        \subsubsection{Indicator Comparison}\label{sec:results:shape:indicatorcomparison}
            ...
            \begin{figure*}[!htb]
                \centering
                \subfigure[]{\includegraphics[width=.205\textwidth]{./experiments/indicatorcomparison/shape/figs/groundtruth.eps}\label{fig:shape:indicatorcomparison:groundtruth}}
                \subfigure[]{\includegraphics[width=.18\textwidth]{./experiments/indicatorcomparison/shape/figs/som10.eps}\label{fig:shape:indicatorcomparison:som:10}}
                \subfigure[]{\includegraphics[width=.18\textwidth]{./experiments/indicatorcomparison/shape/figs/som20.eps}\label{fig:shape:indicatorcomparison:som:20}} 
                \subfigure[]{\includegraphics[width=.18\textwidth]{./experiments/indicatorcomparison/shape/figs/som30.eps}\label{fig:shape:indicatorcomparison:som:30}}
                \subfigure[]{\includegraphics[width=.232\textwidth]{./experiments/indicatorcomparison/shape/figs/som100.eps}\label{fig:shape:indicatorcomparison:som:100}}
            ...
            \begin{figure}
                \centering
                \subfigure[]{\includegraphics[width=.45\columnwidth]{./experiments/indicatorcomparison/shape/figs/zeta_s.eps}\label{fig:shape:indicatorcomparison:zeta_s}} \hspace{0.05\columnwidth}
                \subfigure[]{\includegraphics[width=.45\columnwidth]{./experiments/indicatorcomparison/shape/figs/zeta_epad.eps}\label{fig:shape:indicatorcomparison:rmse}} \\
                \subfigure[]{\includegraphics[width=.45\columnwidth]{./experiments/indicatorcomparison/shape/figs/ssim.eps}\label{fig:shape:indicatorcomparison:ssim}}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{./figs/batan.png}}]
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{./figs/adria.png}}]
