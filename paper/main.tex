...
\begin{document}
	...
	\section{Computational Experiments}\label{sec:results}
        ...
        \subsection{Breast Phantom Study}\label{sec:results:breast}
            ...
            Since the repository provides three-dimensional phantoms while our scattering model is two-dimensional, a representative cross-section focusing on the breast interior was extracted, as shown in Fig. \ref{fig:breast:phantom:ground_truth}. The resulting image contains 328 $\times$ 212 pixels with a spatial resolution of 0.5 mm $\times$ 0.5 mm per pixel. 
