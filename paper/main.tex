...
\begin{document}
	...
	\section{Computational Experiments}\label{sec:results}
		...
		\subsection{Shape Recovering Study}\label{sec:results:shape}
			...
			\subsubsection{Single scatterer}\label{sec:results:shape:star}
                ...
                \begin{figure*}[!htb]
                    \centering
                    \subfigure[Ground-Truth]{\includegraphics[width=0.3\textwidth]{./experiments/shape/star/figs/0.eps}}
                    \subfigure[LSM]{\includegraphics[width=0.3\textwidth]{./experiments/shape/star/figs/1.eps}}
                    \subfigure[OSM]{\includegraphics[width=0.3\textwidth]{./experiments/shape/star/figs/2.eps}} \\
                    \subfigure[BIM]{\includegraphics[width=0.3\textwidth]{./experiments/shape/star/figs/3.eps}}
                    \subfigure[CSI]{\includegraphics[width=0.3\textwidth]{./experiments/shape/star/figs/4.eps}}
                    \subfigure[SOM]{\includegraphics[width=0.3\textwidth]{./experiments/shape/star/figs/5.eps}}
			...
			\subsubsection{Varying contrast}\label{sec:results:shape:varying}
               ...
               % Um outro tipo de estudo possível que pode complementar a análise do desempenho dos algoritmos na reconstrução da geometria dos objetos é a observação do desempenho do indicador com a variação do contraste de um objeto. Ou seja, dado um espalhador, a medida que o seu valor de contraste aumenta, o DNL aumenta e, consequentemente, os algoritmos podem peder desempenho uma vez que o problema fica mais díficil. Para demonstrar isso, o mesmo espalhador com as mesmas configurações de cenário do estudo anterior foi considerado. A única excepção na configuração foi que a resolução da imagem original foi aumentada para 160$\times$160 pixels por questões de precisão no cálculo do campo. O espalhador foi reconstruído com base em cinco valores de contraste: 0.25, 0.5, 0.75, 1 e 1.5. A Fig. \ref{fig:shape:vary:dnl} mostra o DNL para cada valor de contraste. Para este estudo foram considerados os métodos OSM e SOM com as mesmas configurações do estudo anterior. Obviamente, os parâmetros dos métodos poderiam ser ajustados para cada valor de contraste. No entanto, como o experimento tem apenas o fim de demonstrar a aplicabilidade do indicador, os parâmetros foram mantidos constantes para todos os valores de contraste.
                ...
                \begin{figure*}[!htb]
                    \centering
                    \subfigure[OSM, $\chi=0.25$]{\includegraphics[height=1.2in]{./experiments/shape/vary/figs/osm_0.eps}}
                    \subfigure[OSM, $\chi=0.5$]{\includegraphics[height=1.2in]{./experiments/shape/vary/figs/osm_1.eps}}
                    \subfigure[OSM, $\chi=0.75$]{\includegraphics[height=1.2in]{./experiments/shape/vary/figs/osm_2.eps}}
                    \subfigure[OSM, $\chi=1$]{\includegraphics[height=1.2in]{./experiments/shape/vary/figs/osm_3.eps}}
                    \subfigure[OSM, $\chi=1.5$]{\includegraphics[height=1.2in]{./experiments/shape/vary/figs/osm_4.eps}} \\
                    \subfigure[SOM, $\chi=0.25$]{\includegraphics[height=1.in]{./experiments/shape/vary/figs/som_0.eps}}
                    \subfigure[SOM, $\chi=0.5$]{\includegraphics[height=1.in]{./experiments/shape/vary/figs/som_1.eps}}
                    \subfigure[SOM, $\chi=0.75$]{\includegraphics[height=1.in]{./experiments/shape/vary/figs/som_2.eps}}
                    \subfigure[SOM, $\chi=1$]{\includegraphics[height=1.in]{./experiments/shape/vary/figs/som_3.eps}}
                    \subfigure[SOM, $\chi=1.5$]{\includegraphics[height=1.in]{./experiments/shape/vary/figs/som_4.eps}}
                ...
                \begin{figure}[!htb]
                    \centering
                    \subfigure[]{\includegraphics[width=0.48\columnwidth]{./experiments/shape/vary/figs/zeta_s.eps}\label{fig:shape:vary:indicators:zeta_s}} \hspace{0.01\columnwidth}
                    \subfigure[]{\includegraphics[width=0.48\columnwidth]{./experiments/shape/vary/figs/dnl.eps}\label{fig:shape:vary:dnl}}
			...
			\subsubsection{Average performance}\label{sec:results:shape:average}
                ...
                \begin{figure}[!htb]
                    \centering
                    \subfigure[]{\includegraphics[width=.5\columnwidth]{./experiments/shape/average/figs/dnl.eps}\label{fig:shape:average:dnl}} \\
                    \subfigure[]{\includegraphics[width=\columnwidth]{./experiments/shape/average/figs/plot.eps}\label{fig:shape:average:zeta_s}}
		...
		\subsection{Position Detection Study}\label{sec:results:position}
			...
			\subsubsection{Single scatter}\label{sec:results:position:single}
                ...
                \begin{figure*}[!htb]
                    \centering
                    \subfigure[Ground-Truth]{\includegraphics[height=0.5\columnwidth]{../experiments/position/single/figs/0.eps}\label{fig:position:single:ground_truth}}
                    \subfigure[OSM]{\includegraphics[height=0.5\columnwidth]{../experiments/position/single/figs/1.eps}}
                    \subfigure[BIM]{\includegraphics[height=0.5\columnwidth]{../experiments/position/single/figs/2.eps}} \\
                    \subfigure[CSI]{\includegraphics[height=0.5\columnwidth]{../experiments/position/single/figs/3.eps}}
                    \subfigure[SOM]{\includegraphics[height=0.5\columnwidth]{../experiments/position/single/figs/4.eps}}
                    \subfigure[CA]{\includegraphics[height=0.5\columnwidth]{../experiments/position/single/figs/5.eps}}
			...
			\subsubsection{Multiple scatterers}\label{sec:results:position:multiple}
                ...
                \begin{figure*}[!htb]
                    \centering
                    \subfigure[Ground-Truth]{\includegraphics[height=0.5\columnwidth]{../experiments/position/multiple/figs/0.eps}\label{fig:position:multiple:ground_truth}}
                    \subfigure[OSM]{\includegraphics[height=0.5\columnwidth]{../experiments/position/multiple/figs/1.eps}}
                    \subfigure[BIM]{\includegraphics[height=0.5\columnwidth]{../experiments/position/multiple/figs/2.eps}} \\
                    \subfigure[CSI]{\includegraphics[height=0.5\columnwidth]{../experiments/position/multiple/figs/3.eps}}
                    \subfigure[SOM]{\includegraphics[height=0.5\columnwidth]{../experiments/position/multiple/figs/4.eps}}
                    \subfigure[CA]{\includegraphics[height=0.5\columnwidth]{../experiments/position/multiple/figs/5.eps}}
        ...
        \subsection{Breast Phantom Study}\label{sec:results:breast}
            ...
            \begin{figure*}[!htb]
                \centering
                \subfigure[Ground-Truth]{\includegraphics[height=0.55\columnwidth]{../experiments/breast/figs/0.eps}\label{fig:breast:recons:ground_truth}}
                \subfigure[LSM]{\includegraphics[height=0.55\columnwidth]{../experiments/breast/figs/1.eps}}
                \subfigure[OSM]{\includegraphics[height=0.55\columnwidth]{../experiments/breast/figs/2.eps}} \\
                \subfigure[BIM]{\includegraphics[height=0.55\columnwidth]{../experiments/breast/figs/3.eps}} 
                \subfigure[CSI]{\includegraphics[height=0.55\columnwidth]{../experiments/breast/figs/4.eps}}
                \subfigure[SOM]{\includegraphics[height=0.55\columnwidth]{../experiments/breast/figs/5.eps}}
                % \subfigure[CA]{\includegraphics[height=0.4\columnwidth]{../experiments/breast/figs/6.eps}}
    ...
    \section{Conclusion}\label{sec:conclusion}
        ...
        % Uma vez que muitos algoritmos já foram e continuam sendo propostos para o problema inverso de espalhamento eletromagnético e que é importante ter indicadores que sejam capazes de mensurar o desempenho desses algoritmos em diferentes aspectos, este trabalho se propôs a desenvolver dois novos indicadores que podem mensurar de maneira mais isolada dois aspectos que podem ser relevantes para o problema: a localização e a geometria dos espalhadores. Esses indicadores de erro de forma e de posição foram desenvolvidos usando ferramentas de limiarização e detecção de contornos de forma a reduzir o impacto da precisão da estimativa do contraste para possibilitar a mensuração desses aspectos de forma mais independente. Apesar do cálculo desses indicadores depender de uma escolha de nível de limiarização, eles permitem fazer comparações adequadas entre algoritmos qualitativos e quantitavivos, principalmente em cenários com um único espalhador. Portanto, a partir de uma padronização do conjunto de testes, esses indicadores podem ser uma ferramenta significativa para avaliação e comparação de desempenho de métodos propostos na literatura.
        ...
        % Vale à pena destacar também que, com base nos indicadores propostos, os experimentos computacionais realizados considerando um estudo de benchmarking foram capazes de fornecer conclusões na comparação de algoritmos para o problema. Os estudos mostraram que: (a) no cenário com um espalhador e baixo DNL, o BIM tem o melhor desempenho médio na recuperação da forma dos espalhadores em relação aos demais algoritmos considerados; (b) no cenário de pequenos espalhadores de alto contraste, o OSM e o CA têm o melhor desempenho médio na localização dos espalhadores. Outros estudos poderiam ser realizados para elaborar com mais profundidade as diferenças de desempenho entre os algoritmos, o qual não foi o objetivo principal deste trabalho.
        ...
        % Novas investigações podem ser realizadas para aprimorar os indicadores propostos. Uma possibilidade seria se a geometria dos espalhadores puder ser comparada através dos vértices dos objetos de tal forma que a detecção de objetos correspondentes (no caso de múltiplos espalhadores) nas imagens reais e reconstruídas possa ser feita de forma robusta e a diferença na quantidade de pontos do contorno não for um problema. Isso poderia possibilitar que, por exemplo, fosse criado um indicador para mensurar a qualidade da geometria sem levar em consideração a precisão no reconstrução do tamanho do espalhador. Outro caminho possível seria criar diferentes conjuntos de testes que explorem diferentes cenários do problema a fim de serem padrões para comparação de algoritmos. Por fim, a adaptação dos indicadores para problemas tridimensionais também é um caminho possível para futuras investigações.
    ...
    %     The authors would like to thank the reviewers for their valuable contributions. This work was supported in part by the Brazilian agencies FAPEMIG, CNPq, and CAPES (Coordination for the Improvement of Higher Education Personnel).
